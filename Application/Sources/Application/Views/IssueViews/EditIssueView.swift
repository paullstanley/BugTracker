        ...
        VStack {
            GroupBox {
                Form {
                    ...
                    HStack {
                        Button("Save") {
                            let newIssue = IssueDM(id: issue.id, title: title, type: type, creationDate: issue.creationDate, info: info, lastModified: Date().formatted(), project: issue.project, projectIdentifier: issue.project?.stringId ?? "")
